...
export function multiviewGridSpec(tileCount, options) {
...
export function multiviewGridBox(options) {
    ...
    const tileWidth = Math.min(availableWidth / spec.columns, (availableHeight / spec.rows) * aspectRatio);
...
export function multiviewGridTracks(spec) {
    validateGridSpec(spec);
    if (spec.columns === 0) {
...
function validateTrackCount(value, field) {
