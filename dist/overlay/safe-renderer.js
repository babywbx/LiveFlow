export function createSafeOverlayRenderer(container, options = {}) {
    return {
        render(event, presentation) {
...
function renderNode(document, node, options) {
    if (node.type === 'text') {
...
function resolveAssetUrl(document, assetKey, options) {
    let candidate;
    try {
