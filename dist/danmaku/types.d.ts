...
export type DanmakuDropReason = 'duplicate' | 'expired' | 'input-rate' | 'pending-capacity' | 'display-rate' | 'visible-capacity' | 'no-lane' | 'text-too-long' | 'measurement-failed';
...
export type DanmakuDiagnosticCode = 'metadata-discarded' | 'identities-truncated' | 'color-discarded' | 'renderer-failed' | 'clock-failed' | 'measurement-failed' | 'frame-budget-exceeded';
